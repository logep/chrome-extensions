...
~(function (root, factory) {
  ...
  Base64.prototype.decodeByHexString = function (input) {
      var hashBytes = hexStringToBytes(input);
      return this.encode(hashBytes);
  }
  ...
  //https://gist.github.com/siberex/3739369
...
// Converts human-readable hex string to binary buffer.
  ...
  function hexStringToBytes(hexString) {
      ...
      var hexChars = stringToCharArray(hexString);
      var d = [];
